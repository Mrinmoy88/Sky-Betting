...
<main id="primary" class="site-main" style="display:none;">
	...
	<section class="error-404 not-found">
		<header class="page-header">
			<h1 class="page-title"><?php esc_html_e('Oops! That page can&rsquo;t be found.', 'sky_betting'); ?></h1>
		</header><!-- .page-header -->

		<div class="page-content">
			<p><?php esc_html_e('It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'sky_betting'); ?></p>
			...
			<div class="widget widget_categories">
				<h2 class="widget-title"><?php esc_html_e('Most Used Categories', 'sky_betting'); ?></h2>
				<ul>
					<?php
					wp_list_categories(
						array(
			...
			$sky_betting_archive_content = '<p>' . sprintf(esc_html__('Try looking in the monthly archives. %1$s', 'sky_betting'), convert_smilies(':)')) . '</p>';
			the_widget('WP_Widget_Archives', 'dropdown=1', "after_title=</h2>$sky_betting_archive_content");
...
<main>
	...
	<section class="inner-banner">
		...
		<img src="<?= the_field('banner', 'option') ?>" width="1920" height="427" alt="404">
	...
	<section class="privacy_sec c-padd">
		...
		<?php esc_html_e('It looks like nothing was found at this location. Maybe try other keywords again', 'sky_betting'); ?>
				...
				<div class="col-lg-4">
					<div class="betting_txt">
						...
						<div class="menu-btn d-flex">
							<a href="#" class="main-btn main-btn1">
								<span>
							...
							<a href="#" class="main-btn main-btn2">
								<span>
